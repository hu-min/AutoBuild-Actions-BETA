...
rm -rf package/network/services && mv -f package/lean/dnsmasq package/network/services
ExtraPackages svn hostapd https://github.com/openwrt/openwrt/trunk/package/network/services
rm -rf package/network/services && mv -f package/lean/hostapd package/network/services
ExtraPackages svn dropbear https://github.com/openwrt/openwrt/trunk/package/network/services
rm -rf package/network/services && mv -f package/lean/dropbear package/network/services
