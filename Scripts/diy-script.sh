...
Diy-Part1() {
mv $GITHUB_WORKSPACE/Customize/mac80211.sh openwrt/package/kernel/mac80211/files/lib/wifi/mac80211.sh
mv $GITHUB_WORKSPACE/Customize/AutoUpdate.sh openwrt/package/base-files/files/bin/AutoUpdate.sh
mv $GITHUB_WORKSPACE/Customize/system openwrt/package/base-files/files/etc/config/system
#mv $GITHUB_WORKSPACE/Customize/mwan3 openwrt/package/feeds/packages/mwan3/files/etc/config/mwan3
